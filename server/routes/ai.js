...
const { aiController, checkRateLimit } = require('../controllers/aiController');
const router = express.Router();

// Validation middleware for generation requests
...
router.post('/generate', validateGenerationRequest, aiController.generateImage);
